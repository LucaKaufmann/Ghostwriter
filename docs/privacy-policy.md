...
Epilogue is designed for local-first reading workflows. The app can work:

- Locally on your device, and/or
- With an optional self-hosted Ghostwriter server that you configure.

We do not operate a centralized Epilogue cloud service for user content.

## Information We Process

Depending on your setup, Epilogue may process:
...
Information is used only to provide app functionality, including:
...
We use reasonable technical measures in the app and project to reduce unauthorized access. No method of transmission or storage is 100% secure.

## Children's Privacy

Epilogue is not directed to children under 13, and we do not knowingly collect personal information from children under 13.
...
We may update this Privacy Policy from time to time. Updated versions will be posted at the same URL with a revised "Last updated" date.
